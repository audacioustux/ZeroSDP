...
func main() {
	...
	flag.IntVar(&maxConcurrentReconciles, "max-concurrent-reconciles", 2, "The number of maximum concurrent reconciles.")
	opts := zap.Options{
		Development: true,
	}
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&zerosdpv1.Platform{}).SetupWebhookWithManager(mgr); err != nil {
